...
BOT_NAME = getenv("BOT_NAME", "ʀᴀᴅʜᴇ")
ASSUSERNAME = getenv("ASSUSERNAME", "RADHE_MUSIC_ASSISTANT")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/papahuu/Nexonxmusic")
