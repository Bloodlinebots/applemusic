...
OWNER_USERNAME = getenv("OWNER_USERNAME", "unbornvillian")
BOT_USERNAME = getenv("BOT_USERNAME", "APPLE_MUSIC_7BOT")
BOT_NAME = getenv("BOT_NAME", "APPLE MUSIC")
ASSUSERNAME = getenv("ASSUSERNAME", "APPLE_MUSIC_ASSISTANT")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Bloodlinebots/applemusic")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Master")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# ❖ SUPPORT AND CONTACT INFORMATION - PROVIDE YOUR OWN SUPPORT CHANNELS 
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/valahallah")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/bot_backup")
