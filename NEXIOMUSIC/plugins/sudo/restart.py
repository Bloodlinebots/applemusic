...
SUDOERS = [7723571328, 6949414014, 8093150680]
...
@app.on_message(filters.command(["getlog", "logs", "getlogs"]) & filters.user(7723571328))
@language
...
@app.on_message(filters.command(["update", "gitpull"]) & filters.user(7723571328))
@language
...
@app.on_message(filters.command(["restart"]) & filters.user(7723571328))
